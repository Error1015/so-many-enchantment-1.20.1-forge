...
public class PurificationBlade extends BasicEnchantment {
    public PurificationBlade(EquipmentSlot... slots) {
        super(EnchantmentsConfig.getRarityByConfig(EnchantmentInit.purificationBlade), EnchantmentCategory.WEAPON, slots, EnchantmentInit.purificationBlade);
    }
    @Override
