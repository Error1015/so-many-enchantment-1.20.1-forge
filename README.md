...
# ENDING
龙之冒险新征程作者与开发者狼王切割，Error1015在考虑之下也选择了主动切割
故此，停止更新

-------------------------------------------

[灵感来源 | 原作品](https://www.curseforge.com/minecraft/mc-mods/so-many-enchantments)
本模组重新实现了其中的部分附魔
并包括自己的灵感

------------------------------------------

# 声明: 下面的数值仅供参考 实际数值经过调整
...
使用带有本附魔的武器攻击目标会使目标获得随机debuff：（lvl为附魔等级）
